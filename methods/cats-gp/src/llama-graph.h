...
struct llm_graph_params {
    ...
    // Quality computation flag for adaptive sparsity
...
struct llm_graph_context {
    ...
    ggml_tensor * build_ffn(
       ...
       llm_ffn_gate_type   type_gate,
                     int   il,
             ggml_tensor * gate_q = nullptr,
             ggml_tensor * gate_size = nullptr,
             ggml_tensor * down_t = nullptr,
             ggml_tensor * residual = nullptr) const;  // ACAS contrib: pre-ffn-norm residual stream
