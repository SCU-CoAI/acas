...
struct llama_layer {
    ...
    // ff quantization and transposed weights for sparsity
    struct ggml_tensor * ffn_gate_q = nullptr;
    struct ggml_tensor * ffn_gate_size = nullptr; struct ggml_tensor * ffn_down_t      = nullptr;
    struct ggml_tensor * ffn_up_t   = nullptr;
