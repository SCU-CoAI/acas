...
int main(int argc, char ** argv) {
    ...
    llama_decode(ctx_tgt, llama_batch_get_one(inp.data(), n_input - 1), false);
    llama_decode(ctx_tgt, llama_batch_get_one(&inp.back(), 1), false);
    llama_decode(ctx_dft, llama_batch_get_one(inp.data(), n_input), false);
    ...
    while (true) {
...

        {
            ...
            llama_decode(ctx_dft, batch_dft, false);
        ...
        // evaluate the target model on the drafted tokens
        {
            ...
            llama_decode(ctx_tgt, batch_tgt, false);
            ++n_past_tgt;
        }
